...
type NFT struct {
	Mint             solana.PublicKey `json:"mint" bson:"mint"`
	MetadataURL      string           `json:"metadataURL" bson:"metadataURL" `
	HadeswapMarket   solana.PublicKey `json:"hadeswapMarket" bson:"hadeswapMarket"`
	CollectionSymbol string           `json:"collectionSymbol" bson:"collectionSymbol"`
	Price            int              `json:"price" bson:"price"`
}

func (nft *NFT) Type() string {
	return "nft"
}

func (nft *NFT) Value() int {
	return nft.Price
}
